<div>
    ...
    @section('section-header','Data Nasabah')
    <div class="row">
        <div class="col">
            <div class="card">
                                    ...
                                    <div wire:ignore>
                                        ...
                                        <select class="form-control select2 @error('kota_kab_code') is-invalid @enderror" id="kotaKab">
                                            ...
                                            @foreach($kotaKabs as $kotaKab)
                                                @if($kotaKab->id==$kota_kab_code)
                                                <option value="{{$kotaKab->id}}" selected>{{$kotaKab->code." - ".$kotaKab->name}}</option>
                                                @else 
                                    ...
                                    <div wire:ignore>
                                        ...
                                        <select class="form-control select2 @error('marital_status_id') is-invalid @enderror" id="statusPernikahan">
                                            ...
                                            @foreach($maritalStatuses as $maritalStatus)
                                                @if($maritalStatus->id==$marital_status_id)
                                                <option value="{{$maritalStatus->id}}" selected>{{$maritalStatus->code." - ".$maritalStatus->name}}</option>
                                                @else
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    <div wire:ignore>
                                        ...
                                        <select class="form-control select2 @error('job_type_id') is-invalid @enderror" id="jenisPekerjaan">
                                            <option selected>-- Pilih Jenis Pekerjaan --</option>
                                                @foreach($jobTypes as $jobType)
                                                @if($jobType->id==$job_type_id)
                                                    <option value="{{$jobType->id}}" selected>{{$jobType->code." - ".$jobType->name}}</option>
                                                @else 
