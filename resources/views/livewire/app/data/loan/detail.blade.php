<div>
    ...
    @section('section-header','Data Kredit')
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div wire:ignore class="mb-3">
                                            <label for="officeCode">Kantor Bank</label>
                                            <select id="officeCode" class="form-control select2 @error('officeCode') is-invalid @enderror">
                                    ...
                                    <div class="col-lg-7">
                                        <div wire:ignore class="mb-3">
                                            ...
                                            <select wire:model="officeId" id="officeId" class="form-control select2 @error('officeId') is-invalid @enderror" disabled>
                                                <option value="{{Auth::user()->$loan->office->code}}" selected>{{Auth::user()->office->code." - ".Auth::user()->office->name}}</option>
                                            </select>
                                            @error('officeId')
                                            {{$message}}
                                            @enderror
                                        ...
                                        <div class="row">
                                            <div class="col-md-9">
                                                <div class="mx-0">
                                                    ...
                                                    <input type="hidden" wire:model="cif">
                                                    @error('cif')
                                                    {{$message}}
                                                    @enderror
                                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                            <label for="interest_system_code" class="form-label">Sistem Angsuran</label>
                                            <select wire:model.defer="installment_system_code" class="form-control @error('installment_system_code') is-invalid @enderror">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                            ...
                                            <select wire:model.defer="interest_system_code" class="form-control @error('interest_system_code') is-invalid @enderror">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                            ...
                                            <select wire:model.defer="usage_type_code" class="form-control @error('usage_type_code') is-invalid @enderror">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                            ...
                                            <select wire:model.defer="loan_product_code" class="form-control @error('loan_product_code') is-invalid @enderror">
                                                <option selected>-- Pilih Sistem Angsuran --</option>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <select wire:model.defer="quality_id" class="form-control @error('quality_id') is-invalid @enderror">
                                                <option selected>-- Pilih Kualitas Kredit --</option>
                                                @foreach($loanQualities as $loanQuality)
                                                    <option value="{{$loanQuality->id}}">{{$loanQuality->id." - ".$loanQuality->name}}</option>
                                                @endforeach
                                            </select>
                                            @error('quality_id')
                                            {{$message}}
